...
static struct id_addr id_addr_list[] = { 
   ...
   {11, {UIP_HTONS(0xaaaa), 0, 0, 0, UIP_HTONS(0x212), UIP_HTONS(0x7400), UIP_HTONS(0x137b), UIP_HTONS(0xd423)}},
   {12, {UIP_HTONS(0xaaaa), 0, 0, 0, UIP_HTONS(0x212), UIP_HTONS(0x7400), UIP_HTONS(0x137b), UIP_HTONS(0xef83)}},
