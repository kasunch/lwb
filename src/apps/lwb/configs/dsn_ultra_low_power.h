/*
 * dsn_ultra_low_power.h
 *
 *  Created on: Jan 19, 2012
 *      Author: fe
 */

#ifndef DSN_ULTRA_LOW_POWER_H_
#define DSN_ULTRA_LOW_POWER_H_

// configuration values for ultra low-power experiments on DSN
